const CardComponent = ({ title, image, description, onClick }) => (
  <div className="bg-white shadow-lg border border-gray-200 rounded-lg p-4 flex flex-col items-center gap-3">
    ...
    <button
      className="px-4 py-2 bg-blue-500 text-white rounded hover:opacity-80 transition duration-300 cursor-pointer"
      onClick={onClick}
    >
      Enroll now
    </button>
